<template>
  <Sidebar ref="sidebar" title="基本样式">
    <div class="sidebarContent" :class="{ isDark: isDark }" v-if="data">
      ...
      <!-- 概要连线 -->
      <div class="title noTop">概要连线</div>
      <div class="row">
        <div class="rowItem">
          <span class="name">颜色</span>
          <el-popover placement="bottom" trigger="hover" width="auto">
      ...
      <!-- 节点边框风格 -->
      <div class="title noTop">节点边框风格</div>
      <div class="row">
        <div class="rowItem">
          <el-checkbox
      ...
      <!-- 二级节点外边距
      <div class="title noTop">二级节点外边距</div>
      ...
      <!-- </template> -->
      <!-- 其他配置 -->
      <div class="title noTop">其他配置</div>
      <!-- 配置开启自由拖拽 -->
      <div class="row">
        <div class="rowItem">
          <el-checkbox
      ...
      <div class="row">
        <div class="rowItem">
          <el-checkbox v-model="enableNodeRichText" @change="enableNodeRichTextChange">是否启用富文本</el-checkbox>
        </div>
      </div>
      <!-- 配置鼠标滚轮行为 -->
      <div class="row">
        <div class="rowItem">
          ...
          <el-select
            ...
            "
          >
            <el-option label="缩放视图" value="zoom"></el-option>
            <el-option label="上下移动视图" value="move"></el-option>
          </el-select>
        </div>
      </div>
      <!-- 配置鼠标缩放行为 -->
      <div class="row" v-if="config.mousewheelAction === 'zoom'">
        <div class="rowItem">
          ...
          <el-select
            ...
            "
          >
            <el-option label="向前缩小向后放大" :value="false"></el-option>
            <el-option label="向前放大向后缩小" :value="true"></el-option>
          </el-select>
        </div>
      </div>
      <!-- 是否显示滚动条 -->
      <div class="row">
        <div class="rowItem">
          <el-checkbox v-model="localConfigs.isShowScrollbar" @change="updateLocalConfig('isShowScrollbar', $event)">是否显示滚动条</el-checkbox>
        </div>
      </div>
    </div>
  </Sidebar>
